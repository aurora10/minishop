            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                ...
                <div class="single_footer_area mb-100">
                    ...
                    <div class="apps_download">
                        <a href="#"><img src="<?php echo e(asset('storage/img/play-store.png')); ?>" alt="Play Store"></a>
                        <a href="#"><img src="<?php echo e(asset('storage/img/app-store.png')); ?>" alt="Apple Store"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="payment_method">
                        <img src="<?php echo e(asset('storage/img/payment-method/paypal.png')); ?>" alt="">
                        <img src="<?php echo e(asset('storage/img/payment-method/western-union.png')); ?>" alt="">
                        <img src="<?php echo e(asset('storage/img/payment-method/discover.png')); ?>" alt="">
                        <img src="<?php echo e(asset('storage/img/payment-method/american-express.png')); ?>" alt="">
...
<?php /**PATH /Users/albert/minishop/resources/views/site3/partials/footer.blade.php ENDPATH**/ ?>