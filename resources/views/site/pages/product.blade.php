...
{{--                                        <button  class="btn btn-warning"><i class="fas fa-shopping-cart"></i><a href="{{route('checkout.cart')}}"> View Cart</button>--}}
                                        <a
                                            class="btn btn-warning"><i class="fas fa-shopping-cart"></i>View Cart</a>
